...
#### **DAY 9** - Mock Interview #2 + Feedback Integration
**Time: 5-6 hours**
...
#### **DAY 13** - Rest & Mental Preparation (Light Day)
**Time: 2-3 hours**
...
- [ ] Positive affirmations (combat imposter syndrome)
- [ ] Physical activity: Walk, gym, yoga (45-60 minutes)

**Evening**:
- [ ] Technology check (if virtual): camera, microphone, lighting, internet
- [ ] Outfit selection: Professional attire laid out
- [ ] Early bedtime (8+ hours sleep)

**Confidence Check**: Overall readiness ___/10 (Target: 8+)

---

#### **DAY 14** - Final Prep & Interview Eve
**Time: 2-3 hours (Light)**
...
**Afternoon: Logistics & Wellness**

- [ ] **Technology final check** (if virtual):
  - [ ] Camera, microphone, lighting tested
  - [ ] Background professional and uncluttered
  - [ ] Backup device charged
  - [ ] Program coordinator contact info saved

- [ ] **Materials organized**:
  - [ ] CV, personal statement, research abstracts printed
  - [ ] Program notes and questions accessible
  - [ ] Notepad and pen ready
  - [ ] Water bottle (room temp, no ice)

- [ ] **Interview schedule confirmed**:
  - [ ] Times, time zones, program names verified
  - [ ] Reminders set (15 min before each interview)

**Evening: Peak Readiness Protocol**

- [ ] **NO STUDYING** - Trust your preparation
- [ ] Relaxing activity: Light reading, walk, hobby
- [ ] Healthy meal, limit caffeine after 3pm
- [ ] Mindfulness/meditation (10 minutes)
- [ ] Lay out outfit for tomorrow
- [ ] Early bedtime (8+ hours sleep target)
- [ ] Phone on silent, alarms set

**Day 14 Mindset**: "I am prepared. I am confident. I will be authentically myself."
...
| Project | 30-sec Pitch | Key Results | Limitations | Your Role | Rehearsed (x) | Ready? |
|---------|-------------|-------------|-------------|-----------|---------------|--------|
| 1. | | | | | ___/5 | [ ] |
| 2. | | | | | ___/5 | [ ] |
| 3. | | | | | ___/5 | [ ] |
...
| Scenario | Protocol | Practiced (x) | Confidence (/10) |
|----------|----------|---------------|------------------|
| Breaking Bad News | SPIKES | ___/3 | |
| Informed Consent | Risk/benefit/alternatives | ___/3 | |
| Goals of Care | Values, prognosis, ADC | ___/3 | |
...
## 📋 APPLICATION FILE MASTERY

- [ ] **CV**: Know every date, role, supervisor, and can explain any gaps (Day 1)
- [ ] **Personal Statement**: Key themes memorized, can elaborate naturally (Day 1)
- [ ] **Reference Letters**: Know who wrote each and what they likely emphasized (Day 1)
- [ ] **Red Flags**: Prepared explanations for any concerns (lower grades, gaps, etc.) (Day 3)

**Reviewed**: Days 1, 7, 12

---

## 🖥️ LOGISTICS & TECHNOLOGY

### Virtual Interview Setup (if applicable)

- [ ] **Technology tested** (camera, mic, lighting, internet) - Day 13
- [ ] **Backup plan** (second device, hotspot) - Day 13
- [ ] **Background** professional and uncluttered - Day 13
- [ ] **Platform familiarity** (Zoom/Teams) - Day 13

### Interview Day Materials

- [ ] **Professional attire** selected and test-worn - Day 11
- [ ] **Materials organized**: CV, personal statement, program notes, questions - Day 14
- [ ] **Schedule confirmed**: Times, time zones, program names - Day 14
- [ ] **Water bottle**, notepad, pen ready - Day 14
...
### Throughout 2 Weeks:
- [ ] Sleep: 7-8 hours per night (especially Days 4, 8, 12, 13, 14)
- [ ] Exercise: 3-5x per week (30+ minutes)
- [ ] Nutrition: Balanced meals, limit excess caffeine
- [ ] Mindfulness: 10 minutes daily (especially final week)

### Final 48 Hours (Days 13-14):
- [ ] NO heavy studying (trust preparation)
- [ ] Light review only (high-level themes)
- [ ] Relaxing activities (walk, hobby, light reading)
- [ ] Early bedtime (8+ hours sleep)
- [ ] Positive visualization (10 minutes)
...
- [ ] Program fit notes documented
- [ ] Ranking considerations noted
...
| Day | Date | Hours Studied | Key Accomplishments | Confidence Level (/10) | Notes/Adjustments |
|-----|------|---------------|---------------------|------------------------|-------------------|
| 1 | | | | | |
| 2 | | | | | |
| 3 | | | | | |
...
### My Top 3 Strengths to Emphasize:
1. _________________________________________________________________
2. _________________________________________________________________
3. _________________________________________________________________

### Areas of Concern & Mitigation Plans:
1. **Concern**: ______________________ | **Plan**: ______________________
2. **Concern**: ______________________ | **Plan**: ______________________
3. **Concern**: ______________________ | **Plan**: ______________________
...
### Personal Reminders for Interview Day:
1. _________________________________________________________________
2. _________________________________________________________________
3. _________________________________________________________________
...
- "I have prepared thoroughly. I am ready."
- "I will be authentic and let my passion shine through."
- "This program would be lucky to have me."

**During difficult questions:**
- "Take a breath. Structure my thoughts. Then speak."
- "It's okay to pause and think."
- "Show my reasoning, not just my answer."

**When nervous:**
- "This is a conversation, not an interrogation."
- "The interviewers want me to succeed."
- "Confidence comes from preparation, and I am prepared."
...
1. Name: _________________ | Email: _________________ | Phone: _________________
2. Name: _________________ | Email: _________________ | Phone: _________________
3. Name: _________________ | Email: _________________ | Phone: _________________
...
**You are more than your interview.**  
This is one conversation on one day. Your worth as a physician and person is not defined by this single event.

**Authenticity > Perfection.**  
Programs want to see the real you—your passion, your humanity, your growth. Don't try to be perfect; be genuine.

**Trust your preparation.**  
You've put in the work. You know your material. You have compelling stories. Trust yourself.

**The right program will want YOU.**  
Not everyone is the right fit for every program, and that's okay. The programs that rank you highly are the ones where you'll thrive.
